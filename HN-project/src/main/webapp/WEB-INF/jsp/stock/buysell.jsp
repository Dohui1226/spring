		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="section-headline text-center">
					...
					<h6>${stockcode.stock_index}</h6>
					<p>${stockcode.stock_type}</p>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="pricing-content">
				${stocktoday.stock_close}
				<c:if test="${stocklist.stock_diff lt 0}">
					<td style="color: blue">▼${Math.abs(stocklist.stock_diff)}</td>
				</c:if>
				<c:if test="${stocklist.stock_diff gt 0}">
					<td style="color: red">▲ ${stocklist.stock_diff}</td>
				</c:if>
				...
				<div class="price-btn blue">
					<a class="blue-button" data-id="30" data-value="1600"
						data-toggle="modal" href="#modal">매수</a> <a class="blue-button"
						data-id="30" data-value="1600" data-toggle="modal" href="#modal2">매도</a>
				</div>
							...
							<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
								<div class="sale-statistic-inner notika-shadow mg-tb-30">
									...
									<div id="dynamic-chart"
										class="flot-chart dyn-ctn-fr bar-hm-three"></div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="support-content">
						<h6>매수 정보를 입력하세요.</h6>
						<form action="${pageContext.request.contextPath}/stock/buy/${stockcode.stock_code}"
							method="post">
							주문 금액 : ${stocktoday.stock_close}<br>		
							<select id="buyorder" onchange="order1(this.value)">
								...
								<input type="text" id="changemodal1" name="stock_num" placeholder="수량" value=""><br>
								 총 거래금액:<input type="text" id="totalcost2" style="border:none;" value="" ><br>	
								<br>*매수시 거래금액의 0.015% 수수료가 부과됩니다.&nbsp;
								<br>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="support-content">
					<h6>매도 정보를 입력하세요.</h6>
					<form action="${pageContext.request.contextPath}/stock/sell/${stockcode.stock_code}"
						method="post">
							주문 금액 : ${stocktoday.stock_close}<br>
						...
						<input type="text" id="changemodal2" name="stock_num" placeholder="수량" value=""><br> 						
				...
				<%-- 		<fmt:formatNumber id="fee2" value="" pattern="#,###" /> --%>
						<input type="hidden" name="fee" id="feerate2" style="border:none;" value=""> <br>
				</div>
			</div>
			<div class="modal-footer">
...
$(document).ready(function(){
	$("input[name='stock_num']").change(function(){
